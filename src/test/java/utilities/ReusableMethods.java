...
//        String script = "arguments[0].style.border='3px solid green';";
    ...
    public static String generateRandomTc() {
        ...
        StringBuilder tcNumber = new StringBuilder();
        for (int digit : tcNo) {
            tcNumber.append(digit);
        }

        return tcNumber.toString();
    }
    //dosya yolu
    public static String dosyaYolu(String dosyaYoluPath){
        String dosyaYolupath = ConfigReader.getProperty(dosyaYoluPath);
